...
export default function ImageToolbar({ index, onRefresh, processing, setProcessing, onMaskGenerated, showMask, setShowMask, cropMode, setCropMode }: ImageToolbarProps) {
